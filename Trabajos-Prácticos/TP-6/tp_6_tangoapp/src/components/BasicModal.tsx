...
const BasicModal = ({
  ...
  return (
    <div
      ...
      } inset-0 z-50 flex items-center justify-center backdrop-blur-sm transition-opacity duration-[350ms]`}
    >
      <div className="absolute left-0 top-0 h-screen w-screen bg-gray-900 opacity-50" />

      <div
        ref={modalRef}
        className={`z-50 m-auto flex max-h-[95%] w-[95%] flex-col overflow-y-auto rounded-md bg-white text-black shadow-lg ${responsiveSize}`}
      >
        {onClose && (
          <div
